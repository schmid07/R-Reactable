...
For anyone interested in learning more about the Crosstalk aspects of the table (the slider and the search box), again Greg Lin has several helpful examples (linked above). Emily Riederer also has a really helpful tutorial [here](https://emilyriederer.netlify.app/post/crosstalk/).
